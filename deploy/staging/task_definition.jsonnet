...
{
  parameterStoreArn(name):: std.format('arn:aws:ssm:us-west-2:861452569180:parameter/conference-app-staging/%s', name),


  family: 'conference-app-staging-worker',
  ...
  containerDefinitions: [
    {
      ...
      environment: [
        {
          ...
          value: 'https://app-staging.kaigionrails.org',
        },
        {
          name: 'GITHUB_OAUTH_REDIRECT_URI',
          value: 'https://app-staging.kaigionrails.org/auth/github/callback',
        },
        {
          name: 'LANG',
          value: 'en_US.UTF-8',
      ...
      logConfiguration: {
        logDriver: 'awslogs',
        options: {
          'awslogs-group': '/ecs/conference-app-staging-worker',
