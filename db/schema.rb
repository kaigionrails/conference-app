...
ActiveRecord::Schema[8.1].define(version: 2025_09_19_171430) do
  ...
  create_table "tito_tickets", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "event_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["event_id"], name: "index_tito_tickets_on_event_id"
    t.index ["reference"], name: "index_tito_tickets_on_reference"
    t.index ["tito_id"], name: "index_tito_tickets_on_tito_id"
    t.index ["user_id"], name: "index_tito_tickets_on_user_id"
  end
  ...
  add_foreign_key "tito_tickets", "events"
